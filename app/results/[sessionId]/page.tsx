...
export default function ResultsPage({ params }: PageProps) {
  ...
  // Get analysis ID for PayPal
  const analysisId = analysis.analysis_id || analysis.session_id || sessionId;
        ...
        >
          ...
          {paymentSuccess ? (
            <>
              ...
              <h3 className="text-2xl font-bold mb-2">Zahlung erfolgreich!</h3>
              <p className="text-blue-100 mb-6">Dein Report wird heruntergeladen...</p>
              ...
              >
                {downloading ? 'Wird erstellt...' : '📥 Report erneut herunterladen'}
              </button>
            </>
          ) : isReviewMode ? (
            /* Review Mode - Free Download */
            <>
